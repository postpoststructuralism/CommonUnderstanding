...
- Periodic database-backed workers intentionally skip work outside `BackgroundWorkers:ActiveUserWindowMinutes`; confirm a dynamic request refreshed `RecentUserActivity` before treating an idle worker as stuck.
